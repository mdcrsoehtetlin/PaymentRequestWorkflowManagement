# DD_ADMIN_01 窶・Module Overview

> **Doc ID:** PRWM-DD-ADMIN-01 | **Version:** 1.0 | **Status:** Draft  
...
|-------------|------------|----------------|---------|
| Dashboard / List | `/admin/dashboard` | `adminDashboard` | Lists items needing attention |
| Detail View | `/admin/requests/:id` | `RequestDetail` | View specific item |
| [Other Screen] | `/admin/...` | `...` | ... |
