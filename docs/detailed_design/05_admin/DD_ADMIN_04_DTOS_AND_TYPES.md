# DD_ADMIN_04 窶・DTOs and Types

> **Doc ID:** PRWM-DD-ADMIN-04 | **Version:** 1.0 | **Status:** Draft  
...
This document specifies the Data Transfer Objects (DTOs) used by the `admin` module's API endpoints.
