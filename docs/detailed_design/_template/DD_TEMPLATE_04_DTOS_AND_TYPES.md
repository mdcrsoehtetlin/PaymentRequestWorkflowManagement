# DD_{MODULE}_04 — DTOs and Types

> **Doc ID:** PRWM-DD-{MOD}-04 | **Version:** 1.0 | **Status:** Draft  
...
This document specifies the Data Transfer Objects (DTOs) used by the `{ModuleName}` module's API endpoints.

- **Location:** `src/modules/{moduleName}/dto/`

---

## 2. Request DTOs

### 2.1 `Action{ModuleName}Dto`
...
export class Action{ModuleName}Dto {
