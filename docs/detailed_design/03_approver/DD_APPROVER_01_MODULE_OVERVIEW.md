# DD_APPROVER_01 窶・Module Overview

> **Doc ID:** PRWM-DD-APPROVER-01 | **Version:** 1.0 | **Status:** Draft  
...
- **Base Route (Frontend):** `/frontend/src/pages/approver`
- **Base Route (Backend):** `src/modules/approver`
...
|-------------|------------|----------------|---------|
| Dashboard / List | `/approver/dashboard` | `approverDashboard` | Lists items needing attention |
| Detail View | `/approver/requests/:id` | `RequestDetail` | View specific item |
| [Other Screen] | `/approver/...` | `...` | ... |
