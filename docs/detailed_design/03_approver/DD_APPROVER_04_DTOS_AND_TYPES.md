# DD_APPROVER_04 窶・DTOs and Types

> **Doc ID:** PRWM-DD-APPROVER-04 | **Version:** 1.0 | **Status:** Draft  
...
This document specifies the Data Transfer Objects (DTOs) used by the `approver` module's API endpoints.
...
export class ActionapproverDto {
