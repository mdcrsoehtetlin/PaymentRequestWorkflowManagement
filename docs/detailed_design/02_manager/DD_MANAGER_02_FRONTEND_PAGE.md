# DD_MANAGER_02 窶・Frontend Page Specification

> **Doc ID:** PRWM-DD-MANAGER-02 | **Version:** 1.0 | **Status:** Draft  
...
- **File Path:** `frontend/src/pages/manager/{PageName}.tsx`
- **Route:** `/manager/...`
...
```typescript
// Example:
// frontend/src/pages/manager/hooks/use{Data}.ts
