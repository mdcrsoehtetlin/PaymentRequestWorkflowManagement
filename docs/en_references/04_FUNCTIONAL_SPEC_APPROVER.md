...
| :--- | :--- | :--- |
| PRWM-SIS-SCR-003 | Screen Items Specification — Approver Dashboard | Defines the physical field layout, input types, initial values, and display specifications for all UI elements referenced in this functional specification. |
| PRWM-DDS-SCR-003 | Detail Design Specification — Approver Dashboard | Defines API endpoint contracts, database query implementations, and processing sequence diagrams that implement the functional operations specified herein. |
